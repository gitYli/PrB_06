                    ...
                    <form action="/services" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row gy-1 gy-xl-1 p-3 p-xl-4">
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control" name="Services_description" id="Services_description"
    ...
    <div class="row gap-1 m-xl-0 mx-1">
        @foreach($users as $value)
            <div class="col-12 col-lg-4 card shadow-sm p-0 m-xl-0 mb-1">
                <img class="card-img-top" src="{{ url('Images/'.$value->Services_img) }}" alt="Card image"
                     style="width:100%">
                <div class="card-body d-flex flex-column">
                    <h4 class="card-title">{{ $value->Services_name }}</h4>
                    <span class="card-text" style="white-space: pre-wrap">{{ $value->Services_description }}</span>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-body">
                            <h4>هل انت متأكد من حذف {{ $value->Services_name }}؟</h4>
                            ...
                            <a type="button" class="btn btn-block btn-danger" style="width: 49%"
                               href="{{ url('/services/delete/' . $value->id ) }}">حذف</a>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <form action="/services/edit/{{$value->id}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 gy-1 gy-xl-1">
                                            <label class="form-label" for="Services_name">العنوان</label>
                                            <input type="text" class="form-control" name="Services_name" id="Services_name"
                                                   value="{{ $value->Services_name }}" required>
                                        </div>
                                        <div class="col-12 gy-1 gy-xl-1">
                                        ...
                                        <div class="col-12 gy-1 gy-xl-1">
                                            <label for="Services_description" class="form-label">الوصف</label>
                                            <textarea class="form-control" name="Services_description" id="Services_description"
                                                      rows="4" required>{{ $value->Services_description }}</textarea>
                                        </div>
                                        <div class="col-12 gy-1 gy-xl-1">
                                            <div class="d-grid">
                                                <button class="btn btn-primary btn-lg" type="submit">ارسال</button>
